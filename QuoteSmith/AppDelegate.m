...
- (void) StyleTheApp
{
    ...
    [titleBarAttributes setValue:[UIFont fontWithName:@"Futura-CondensedExtraBold" size:21] forKey:NSFontAttributeName];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"QuoteSmith" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"QuoteSmith.sqlite"];
